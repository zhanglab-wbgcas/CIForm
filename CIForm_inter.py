...
def CIForm(s):
    ...
    # gap, Traindata_paths, Train_names,
    # Testdata_path, Testdata_name, topgenes
    referece_datapath = []
    Train_names = []
    Testdata_path = []
    Testdata_name = []
    train_data, labels, query_data, cell_types = getData(gap, referece_datapath,Train_names,Testdata_path,
